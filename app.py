...
if uploaded_file is not None:
    ...
    # Виправлення злипшихся слів
    full_text = re.sub(r"(?<=[а-яА-Яїєґ\d])(?=[А-ЯІЇЄҐ])", " ", full_text)

    # Розбиваємо текст за роками
    ...
    if yearly_data:
        ...
        # Визначення типу довідки (ОК-5 / ОК-7)
        doc_type = "ОК-?"
        ...
        # Оновлений текст коментаря під 30%
        copy_text = (
